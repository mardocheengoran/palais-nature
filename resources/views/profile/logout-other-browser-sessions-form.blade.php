<x-jet-action-section>
    <x-slot name="title">
        {{ __('Connexions actives') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Gérez et déconnectez-vous de vos connexions actives sur les autres navigateurs et appareils.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Veuillez entrer votre mot de passe pour confirmer que vous souhaitez vous déconnecter de vos autres sessions de navigation sur tous vos appareils.') }}
