                            ...
                            <tr>
                                <td class="sm-py-32 sm-px-24" style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; padding: 48px; text-align: center;" align="center">
                                    <a href="{{ route('welcome') }}">
                                        <img src="{{ asset('img/logo.png') }}" width="155" alt="17 Educ" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;" />
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" class="sm-px-24" style="font-family: 'Montserrat', Arial, sans-serif;">
                                    <table style="font-family: 'Montserrat', Arial, sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            ...
                                            >
                                                <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Bonjour</p>
                                                <p style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1; color: #ff5850; color: rgba(255, 88, 80, var(--text-opacity));">{{ $user->fullname }} <span style="color: #111111;">s'est inscrit sur Bezo</span></p>
                                                <p style="margin: 0 0 24px;">
                                                    <p>
                                                        Nom & prénoms : <span style="font-weight: 600;">{{ $user->fullname }}</span>
                                                    </p>
                                                    <p>
                                                        Pays : <span style="font-weight: 600;">{{ $user->pays->title }}</span>
                                                    </p>
                                                    <p>
                                                        Email : <span style="font-weight: 600;">{{ $user->email }}</span>
                                                    </p>
                                                    <p>
                                                        Numéro téléphone : <span style="font-weight: 600;">{{ $user->phone }}</span>
                                                    </p>
                                                    @if ($user->hasRole(['fournisseur']))
                                                        <hr>
                                                        <h1>Info boutique</h1>
                                                        <p>
                                                            Nom de la boutique : <span style="font-weight: 600;">{{ $user->store }}</span>
                                                        </p>
                                                        <p>
                                                            Commune : <span style="font-weight: 600;">{{ $user->city->title }}</span>
                                                        </p>
                                                        <p>
                                                           Localisaton exact de votre boutique : <span style="font-weight: 600;">{{ $user->address }}</span>
                                                        </p>
                                                        <hr>
                                                    @endif
                                                    <p>
                                                ...
                                                {{-- <a href="https://pixinvent.com?reset_password_url"
                                                    ...
                                                    https://pixinvent.com?reset_password_url
                                                </a> --}}
                                                <table style="font-family: 'Montserrat', Arial, sans-serif;" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr>
                                                        ...
                                                        >
                                                            <a href="{{ route('user.show', $user->id) }}" style="
                                                                display: block;
                                                                font-weight: 600;
                                                                font-size: 14px;
                                                                line-height: 100%;
