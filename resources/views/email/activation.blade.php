...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; --bg-opacity: 1; background-color: #eceff1; background-color: rgba(236, 239, 241, var(--bg-opacity));">
        <div style="display: none;">Une inscription sur 17Educ</div>
                                    ...
                                    <table style="font-family: 'Montserrat', Arial, sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td
                                                ...
                                                <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Bravo {{ $user->fullname }}</p>
                                                <p style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1; color: #ff5850; color: rgba(255, 88, 80, var(--text-opacity));">
                                                    Votre compte sur <span style="font-size: 24px;">17 Educ</span> a bien été activé
                                                </p>
                                                {{-- <p style="margin: 0 0 24px;">
                                                    <p>Adresse IP : <span style="font-weight: 600;">{{ request()->ip(); }}</span></p>
                                                </p> --}}
                                                <p style="margin: 0 0 24px;">
                                                    Cliquez sur ce lien pour commencer à suivre les cours
                                                </p>
