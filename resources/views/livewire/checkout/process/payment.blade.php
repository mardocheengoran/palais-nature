    ...
    @if(($invoice->address_id or $invoice->relay_id) and $invoice->delivery_mode_id /* and !$invoice->payment_method_id */)
        <div class="card-body">
            ...
            <form class="row">
                ...
                @error('payment')
                    <div class="col-12">
                        <div class="mb-3 text-danger" style="margin-top: -10px;">
                            <strong>{{ $message }}</strong>
                        </div>
                    </div>
                @enderror
                <div class="col-12 text-end">
                    <button type="button" wire:loading.class="text-white bg-dark" wire:loading.attr="disabled" wire:click='paymentNext' class="btn btn-warning text-uppercase">
            ...
            <form class="checkout woocommerce-checkout" enctype="multipart/form-data">
                ...
                {{-- <div>
                    @foreach ($payments as $item)
                        <div class="mb-2 form-check form-option form-check-inline">
