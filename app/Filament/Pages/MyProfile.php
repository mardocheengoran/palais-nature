...
{
    use HasBreezyTwoFactor, HasPageShield;

    protected function getShieldRedirectPath(): string {
        return route('filament.pages.dashboard'); // redirect to the root index...
    }
    ...
    protected function getUpdateProfileFormSchema(): array
    {
        return [
            ...
            ->required()
            ->visible(auth()->user()->hasRole(['fournisseur'])),

            Select::make('city_id')
            ->label('Zone')
            ->required()
            ->options(Parameter::orderBy('title', 'asc')
