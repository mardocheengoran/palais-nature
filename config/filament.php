...
use App\Http\Middleware\RegisterSupplierMiddleware;
...
return [
    ...
    */
    ...
    'brand' => env('APP_NAME'),
    //'brand' => '<img src="/img/seller.png" alt="logo">',
    ...
    */
    ...
    //'google_fonts' => 'https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;1,400;1,500;1,600&display=swap',
    ...
    */
    ...
    'middleware' => [
        'auth' => [
            Authenticate::class,
            'role:admin|super_admin|fournisseur|livreur',
            RegisterSupplierMiddleware::class,
        ],
        'base' => [
